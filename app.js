...
// alert(str + "\n" + str.slice(0,-1) + "\n" + str.slice(0,-2) + "\n" + str.slice(0,-3) + "\n" + str.slice(0,-4) + "\n" + str.slice(0,-5))
/* Task 6 */
// var email = "ebadshahidz@hotmail.com"
...
// product = prompt("what is product title")
// qty     = prompt("Quantity")
// document.write(visitor +" ordered "+qty+" "+product+ "(s) on XYZ Clothing store")
...
// var sub = (+num1)-(+num2)
// alert("sum of "+num1 + " and "+num2+" is "+sub)
// var mul  = (+num1)*(+num2)
// alert("sum of "+num1 + " and "+num2+" is "+mul)
// var div  = (+num1)/(+num2)
// alert("sum of "+num1 + " and "+num2+" is "+div)
// var mod  = (+num1)%(+num2)
// alert("sum of "+num1 + " and "+num2+" is "+mod)
...
// /* Task 4 */
// var ticket = prompt("Enter ticket price")
// var qty    = prompt("how many tickets you want?")
// alert("Total cost buy "+qty+" tickets to a movie is "+(ticket*qty)+" PKR") 
// /* Task 5 */
...
// }
// /* Task 6 */
// var fa= prompt("Enter temperature in fahrenhiet")
// var formula= (fa-32)*(5/9)
// document.write(fa+"F is "+formula+" C")

/* Task 7 */
// var item1= prompt("a. Price of item 1") 
// var item2= prompt("b. Price of item 2")
// var qty1= prompt("c. Ordered quantity of item 1")
// var qty2= prompt("d. Ordered Quantity of item 2")
// var address= prompt("e. Shipping charges")
...
// document.write("<br>")
// document.write("shipping charges "+address)
// document.write("<br>")
// total = (item1*qty1)+(item2*qty2)+(+address)
// document.write("Total cost of your order is "+total)

/* Task 8 */
// var total_marks= prompt("Enter total marks")
// var marks_obtained= prompt("Enter you marks obtained")
...
// var d_pkr = 10*104.80
// var s_pkr = 25*28
// document.write("Total currency in PKR "+(d_pkr+s_pkr))
...
// var max_age = 65
// var amount_of_snack = prompt("Enter amount of snack per day")
// var formula = (65*365)/3
// document.write("You will need "+formula + " to last you until the ripe old age of "+max_age)
...
// document.write("be is "+b)
// document.write("result is "+result)

// /* Task 3 and 4 */

// var name = prompt("Write Your Name")
// document.write(name+" , How are you?")
...
// var sub1 = prompt("Write Your subject 1")
// var sub2 = prompt("Write Your subject 2")
// var sub3 = prompt("Write Your subject 3")
// t_marks=300
// var sub11 = prompt("Write Your subject 1 marks")
// var sub22 = prompt("Write Your subject 2 marks")
// var sub33 = prompt("Write Your subject 3 marks")
// o_marks= (+sub11)+(+sub22)+(+sub33)
// per= (o_marks/t_marks)*100
// document.write(sub1+" "+"100"+sub11+" "+per)
// document.write(sub2+" "+"100"+sub22+" "+per)
// document.write(sub3+" "+"100"+sub33+" "+per)
...
// }
// /* Task 3 */
// var color = prompt("input color of road signal")
// if (color==="red")
// {
//     alert("Must stop")
// }
...
// else
// {
//     alert("Your guess Number is: "+guess)
//     alert("Better luck next time")
// }
// /* Task 8 */
// var num = prompt("check the number divisible by 3")
// if((+num)%3===0)
// {
...
// }
// /* Task 9 */
// var num = prompt("check the number even or odd")
// if((+num)%2===0)
// {
...
// else
// {
//     alert("Sorry, write correct values")
// }
// /* Task 11 */
// var num1 = prompt("Enter number 1")
// var num2 = prompt("Enter number 2")
// var op = prompt("what operation you want to perform?")
// var add = (+num1)+(+num2)
// var sub = (+num1)-(+num2)
// var mul = (+num1)*(+num2)
// var div = (+num1)/(+num2)
...
// if (op==="+")
// {
//     alert(num1+" "+op+" "+num2+" "+add)
// }
// if (op==="-")
// {
//     alert(num1+" "+op+" "+num2+" "+sub)
// }
// if (op==="*")
// {
//     alert(num1+" "+op+" "+num2+" "+mul)
// }
// if (op==="/")
// {
//     alert(num1+" "+op+" "+num2+" "+div)
// }
// if (op==="%")
// {
//     alert(num1+" "+op+" "+num2+" "+mod)
// }
// else
// {
